      ...
      <h3 class="pb-3">
        ...
        <div class="row mb-2">
          <div class="col-md-7">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                <h5 class="d-inline-block mb-2">{{products[0].titel}}</h5>
                <h6 class="mb-5">
          ...
          <div class="col-md-5 pl-0">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                <h5 class="d-inline-block mb-2">{{products[1].titel}}</h5>
                <h6 class="mb-5">
        ...
        <div class="row mb-2">
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                <h5 class="d-inline-block mb-3">{{products[2].titel}}</h5>
          ...
          <div class="col-md-7 pl-0">
            <div class="row pr-3">
              <div class="col-md-4 p-0 pl-2" v-for="(p,i) of products.slice(3)" :key="i">
...
export default {
  data(){
    return {
      products:[
        {title:"",details:"",pic:"",price:0,href:""},
        {title:"",details:"",pic:"",price:0,href:""},
        {title:"",details:"",pic:"",price:0,href:""}
      ]
    }
